...
void main() {
  ...
  testWidgets('CalendarGrid task popover opens without context errors', (
    tester,
  ) async {
    ...
    await tester.tap(find.text('Weekly Sync').first, warnIfMissed: false);
    await tester.pump();
    ...
    home: BlocProvider<SettingsCubit>.value(
      ...
      child: MultiBlocProvider(
        ...
        child: ShadTheme(
          ...
          child: Scaffold(
            body: SizedBox(width: 1280, height: 860, child: child),
          ),
        ),
      ),
    ),
