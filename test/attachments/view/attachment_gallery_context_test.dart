...
void main() {
  testWidgets('AttachmentGalleryRoute survives opener disposal', (
    tester,
  ) async {
          ...
          onPressed: () {
            ...
            Navigator.of(context).push<void>(
              MaterialPageRoute<void>(
                builder: (_) => AttachmentGalleryScreen(locate: locate),
              ),
            );
          },
          child: const Text('Open attachment gallery'),
        ),
      ),
    );

    await tester.tap(find.text('Open attachment gallery'));
