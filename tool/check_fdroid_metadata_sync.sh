...
check_count 1 "python3 -c 'import base64; from pathlib import Path;" 'generated in_app_update helper creation prefix'
check_count 1 'Path(".fdroid_patch_in_app_update.py").write_bytes(' 'generated in_app_update helper write target'
check_count 1 'base64.b64decode(' 'generated in_app_update helper decode command'
check_count 1 'python3 .fdroid_patch_in_app_update.py "$PUB_CACHE"' 'generated in_app_update helper invocation'
check_count 1 'rm -f .fdroid_patch_in_app_update.py' 'generated in_app_update helper cleanup'
