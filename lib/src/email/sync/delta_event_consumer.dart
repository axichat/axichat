    ...
    try {
      ...
      if (!isOutgoing &&
        ...
        final blocklistEntry = blockAddress == null
            ? null
            : await _timedDeltaTraceStep(
                () => db.getEmailBlocklistEntry(blockAddress),
                (elapsedMs) => timing.downloadGateMs += elapsedMs,
              );
