...
const String _deltaGeneratedMessageIdPrefix = 'gen_';

const String derivedEmailMessageKeyPrefix = 'axi-drv-';

const String _derivedEmailMessageKeyFieldSeparator = '\x00';

final RegExp _emailMessageIdWhitespaceRegex = RegExp(r'\s+');
...
String canonicalEmailOriginId({
  required String? rfc724Mid,
  required String? subject,
  required DateTime? timestamp,
  required String? bodyText,
}) {
