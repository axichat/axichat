...
export 'axi_attention_shake.dart';
...
export 'connection_status_indicators.dart';
export 'context_action_button.dart';
export 'cutout.dart';
...
export 'keyboard_pop_scope.dart';
...
export 'recipient_chips_bar.dart';
export 'recipient_picker_sheet.dart';
...
const calendarViewMobileEnterOffset = Offset(0.0, 1 / 24);
...
const calendarAutoPageDebounceDelay = Duration(milliseconds: 400);
const calendarDragTabSwitchDelay = Duration(milliseconds: 300);
const calendarDragTabDayShiftDelay = Duration(milliseconds: 600);
...
const calendarMonthCellMinHeight = 120.0;
