...
class AxiInputFormField extends ShadFormBuilderField<String> {
  ...
  @override
  ShadFormBuilderFieldState<AxiInputFormField, String> createState() =>
      _ShadFormBuilderInputState();
}

class _ShadFormBuilderInputState
    extends ShadFormBuilderFieldState<AxiInputFormField, String> {
  TextEditingController? _controller;

  TextEditingController get controller => widget.controller ?? _controller!;
  final GlobalKey<AxiInputState> inputKey = GlobalKey<AxiInputState>();
  ...
  @override
  void didUpdateWidget(covariant AxiInputFormField oldWidget) {
