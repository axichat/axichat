...
abstract class AppLocalizations {
  ...
  /// No description provided for @linkedEmailAccountsTitle.
  ///
  /// In en, this message translates to:
  /// **'Email accounts'**
  String get linkedEmailAccountsTitle;

  /// No description provided for @linkedEmailAccountsDescription.
  ///
  /// In en, this message translates to:
  /// **'Link existing inboxes and send from multiple addresses.'**
  String get linkedEmailAccountsDescription;

  /// No description provided for @linkedEmailAccountsDefaultHint.
  ///
  /// In en, this message translates to:
  /// **'New chats send from your default address unless you switch it per chat.'**
  String get linkedEmailAccountsDefaultHint;

  /// No description provided for @linkedEmailAccountsLimitHint.
  ///
  /// In en, this message translates to:
  /// **'Up to {limit} extra accounts.'**
  String linkedEmailAccountsLimitHint(Object limit);

  /// No description provided for @linkedEmailAccountsLinkAction.
  ///
  /// In en, this message translates to:
  /// **'Link account'**
  String get linkedEmailAccountsLinkAction;

  /// No description provided for @linkedEmailAccountsUnsupportedHint.
  ///
  /// In en, this message translates to:
  /// **'This device supports one email account at a time.'**
  String get linkedEmailAccountsUnsupportedHint;

  /// No description provided for @linkedEmailAccountsEmptyTitle.
  ///
  /// In en, this message translates to:
  /// **'No linked accounts yet'**
  String get linkedEmailAccountsEmptyTitle;

  /// No description provided for @linkedEmailAccountsEmptyDescription.
  ///
  /// In en, this message translates to:
  /// **'Add an existing inbox to sync mail and send from it.'**
  String get linkedEmailAccountsEmptyDescription;

  /// No description provided for @linkedEmailAccountsLoadFailure.
  ///
  /// In en, this message translates to:
  /// **'Unable to load email accounts.'**
  String get linkedEmailAccountsLoadFailure;

  /// No description provided for @linkedEmailAccountsMakeDefaultAction.
  ///
  /// In en, this message translates to:
  /// **'Make default'**
  String get linkedEmailAccountsMakeDefaultAction;

  /// No description provided for @linkedEmailAccountsUpdatePasswordAction.
  ///
  /// In en, this message translates to:
  /// **'Update password'**
  String get linkedEmailAccountsUpdatePasswordAction;

  /// No description provided for @linkedEmailAccountsDefaultBadge.
  ///
  /// In en, this message translates to:
  /// **'Default'**
  String get linkedEmailAccountsDefaultBadge;

  /// No description provided for @linkedEmailAccountsRemoveTitle.
  ///
  /// In en, this message translates to:
  /// **'Remove linked account?'**
  String get linkedEmailAccountsRemoveTitle;

  /// No description provided for @linkedEmailAccountsRemoveDescription.
  ///
  /// In en, this message translates to:
  /// **'You can re-link later. Existing messages stay.'**
  String get linkedEmailAccountsRemoveDescription;

  /// No description provided for @linkedEmailAccountsUpdateTitle.
  ///
  /// In en, this message translates to:
  /// **'Update email password'**
  String get linkedEmailAccountsUpdateTitle;

  /// No description provided for @linkedEmailAccountsAccountLabel.
  ///
  /// In en, this message translates to:
  /// **'Account'**
  String get linkedEmailAccountsAccountLabel;

  /// No description provided for @linkedEmailAccountsSheetTitle.
  ///
  /// In en, this message translates to:
  /// **'Link an email account'**
  String get linkedEmailAccountsSheetTitle;

  /// No description provided for @linkedEmailAccountsSheetSubtitle.
  ///
  /// In en, this message translates to:
  /// **'Use an app password if your provider requires it.'**
  String get linkedEmailAccountsSheetSubtitle;

  /// No description provided for @linkedEmailAccountsAddressPlaceholder.
  ///
  /// In en, this message translates to:
  /// **'name@domain.com'**
  String get linkedEmailAccountsAddressPlaceholder;

  /// No description provided for @linkedEmailAccountsAddressRequired.
  ///
  /// In en, this message translates to:
  /// **'Enter an email address.'**
  String get linkedEmailAccountsAddressRequired;

  /// No description provided for @linkedEmailAccountsAddressInvalid.
  ///
  /// In en, this message translates to:
  ...
  /// In en, this message translates to:
  /// **'Enter app password'**
  String get linkedEmailAccountsPasswordPlaceholder;

  /// No description provided for @linkedEmailAccountsPasswordLabel.
  ///
  /// In en, this message translates to:
  /// **'App password'**
  String get linkedEmailAccountsPasswordLabel;

  /// No description provided for @linkedEmailAccountsSetDefaultLabel.
  ///
  /// In en, this message translates to:
  /// **'Set as default send address'**
  String get linkedEmailAccountsSetDefaultLabel;

  /// No description provided for @linkedEmailAccountsSetDefaultDescription.
  ///
  /// In en, this message translates to:
  /// **'New chats send from this address by default.'**
  String get linkedEmailAccountsSetDefaultDescription;

  /// No description provided for @linkedEmailAccountsLimitReached.
  ///
  /// In en, this message translates to:
  /// **'You can link up to {limit} extra accounts.'**
  String linkedEmailAccountsLimitReached(Object limit);

  /// No description provided for @linkedEmailAccountsUnsupportedError.
  ///
  /// In en, this message translates to:
  /// **'Multiple accounts are not supported on this device.'**
  String get linkedEmailAccountsUnsupportedError;

  /// No description provided for @linkedEmailAccountsLinkFailure.
  ///
  /// In en, this message translates to:
  /// **'Unable to link account.'**
  String get linkedEmailAccountsLinkFailure;

  /// No description provided for @linkedEmailAccountsUnlinkFailure.
  ///
  /// In en, this message translates to:
  /// **'Unable to remove account.'**
  String get linkedEmailAccountsUnlinkFailure;

  /// No description provided for @linkedEmailAccountsDefaultFailure.
  ///
  /// In en, this message translates to:
  /// **'Unable to update default address.'**
  String get linkedEmailAccountsDefaultFailure;

  /// No description provided for @linkedEmailAccountsUpdateFailure.
  ///
  /// In en, this message translates to:
  /// **'Unable to update password.'**
  String get linkedEmailAccountsUpdateFailure;
