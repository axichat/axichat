...
extension TaskOccurrenceOverrideSnapshotX on TaskOccurrenceOverride {
  TaskOccurrenceOverride clone() => TaskOccurrenceOverride(
        scheduledTime: scheduledTime,
        duration: duration,
        endDate: endDate,
        daySpan: daySpan,
...
extension RecurrenceRuleSnapshotX on RecurrenceRule {
  RecurrenceRule clone() => RecurrenceRule(
        frequency: frequency,
        interval: interval,
        byWeekdays: byWeekdays == null
            ? null
            : List<int>.from(byWeekdays!),
        until: until,
        count: count,
      );
}

extension CalendarTaskSnapshotX on CalendarTask {
  CalendarTask clone() => CalendarTask(
        id: id,
        title: title,
        description: description,
        scheduledTime: scheduledTime,
