...
class GuestCalendarBloc extends Bloc<CalendarEvent, CalendarState> {
  GuestCalendarBloc({
    required Box<CalendarModel> guestCalendarBox,
    String? deviceId,
  })  : _calendarBox = guestCalendarBox,
  ...
  Future<void> _onCalendarTaskAdded(
    ...
    try {
      ...
      developer.log('Error adding task: $e', name: 'GuestCalendarBloc');
  ...
  Future<void> _onCalendarTaskUpdated(
    ...
    try {
      ...
      developer.log('Error updating task: $e', name: 'GuestCalendarBloc');
      emit(state.copyWith(isLoading: false, error: error));
    }
  }
  ...
  Future<void> _onCalendarTaskDeleted(
    ...
    try {
      ...
      developer.log('Error deleting task: $e', name: 'GuestCalendarBloc');
      emit(state.copyWith(isLoading: false, error: error));
    }
  }
  ...
  Future<void> _onCalendarTaskCompleted(
    ...
    try {
      ...
      developer.log('Error completing task: $e', name: 'GuestCalendarBloc');
      emit(state.copyWith(isLoading: false, error: error));
    }
  }
