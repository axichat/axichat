...
class CalendarBloc extends BaseCalendarBloc {
  ...
  void emitModel(
    ...
    super.emitModel(
      ...
      criticalPathMutationOutcomeToken: criticalPathMutationOutcomeToken,
    );
