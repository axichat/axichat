  ...
  String label(
    ...
    String? moderationTarget,
      ...
      switch (this) {
        ...
        ChatMessageKey.messageErrorServerTimeout =>
          l10n.messageErrorServerTimeout,
        ...
        ChatMessageKey.messageErrorMalformedKey =>
          l10n.messageErrorMalformedKey,
        ...
        ChatMessageKey.messageErrorNoKeyMaterial =>
          l10n.messageErrorNoKeyMaterial,
        ...
        ChatMessageKey.messageErrorEmailBounced =>
          l10n.messageErrorEmailBounced,
        ChatMessageKey.messageErrorEmailThrottled =>
          l10n.messageErrorEmailThrottled,
        ChatMessageKey.chatComposerEmptyMessage =>
          l10n.chatComposerEmptyMessage,
        ...
        ChatMessageKey.chatAttachmentSendFailed =>
        ...
        ChatMessageKey.chatNicknameUpdateFailed =>
          l10n.chatNicknameUpdateFailed,
