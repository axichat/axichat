  ...
  static List<DemoChatScript> _buildScripts() {
    ...
    final groupMessages = [
      ...
      message(
        ...
        chatJid: groupJid,
        body:
            'I can grab the last screenshots and copy notes as soon as legal gives us the green light.',
      ...
      message(
        ...
        chatJid: groupJid,
        body:
            'Once we go live, I’ll keep an eye on things and pass any hot issues to support.',
      ...
      message(
        ...
        chatJid: groupJid,
        body:
            'Let’s stop UI polish at 2:30, then we can lock in translations and the final theme tweaks.',
      ...
      message(
        ...
        chatJid: groupJid,
        body: 'I wrote a quick launch game plan so we’re all in sync.',
      ...
      message(
        ...
        chatJid: groupJid,
        body: 'If it hiccups again, we pause, rerun, and keep moving.',
      ...
      message(
        ...
        senderJid: '$groupJid/Thomas',
        chatJid: groupJid,
        body: 'Quick one, I put together a tiny launch runbook for everyone.',
      ...
      taskShareMessage(
        ...
        chatJid: groupJid,
        body:
            'Quick check-in: hardening is mostly done, and there are just three launch checks left.',
